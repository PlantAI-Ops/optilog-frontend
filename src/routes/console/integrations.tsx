...
import { SOURCE_LABEL, connectors, type Connector } from "@/lib/ops-model";
...
const healthTone: Record<Connector["health"], string> = {
  healthy: "bg-success",
  degraded: "bg-warning",
...
function DirectionIcon({ direction }: { direction: Connector["direction"] }) {
  ...
  return (
    ...
    >
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        <StatCard label="Connectors" value={connectors.length} hint="4 inbound · 1 outbound · 1 two-way" />
          ...
          <div className="rounded-xl border border-border bg-card p-4">
            <div className="flex flex-wrap items-center justify-between gap-3">
              ...
              <div className="flex items-center gap-2">
                <SourceBadge>{SOURCE_LABEL[connector.system]}</SourceBadge>
